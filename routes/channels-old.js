/*
  This the old channels-list route.

  It uses "counters" in order to keep track of asynchronous API calls as well
  as nesting functions on each other to achieve a "waterfall" effect.

  The new version uses Promises to handle the asynchronous nature of
  the code.
*/
